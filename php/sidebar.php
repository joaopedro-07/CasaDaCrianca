...
<aside id="sidebar" class="sidebar">
    <div>
        ...
        <ul class="menu-list">
            ...
            <li class="menu-item <?php echo htmlspecialchars(($pagina_atual == 'inicio.php') ? 'active' : ''); ?>">
            ...
            <li class="menu-item <?php echo htmlspecialchars(($pagina_atual == 'renda_beneficios.php') ? 'active' : ''); ?>">
                <a href="estatisticas_criancas.php" class="menu-link">
                    ...
                    <span>Estatísticas das Crianças</span>
                </a>
            </li>

            <li class="menu-item <?php echo htmlspecialchars(($pagina_atual == 'perfil.php') ? 'active' : ''); ?>">
            ...
            <li class="menu-item <?php echo htmlspecialchars(($pagina_atual == 'suporte.php') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer" style="width: 100%;">
        <div class="linha-sidebar" style="height: 1px; background-color: rgba(255, 255, 255, 0.1); margin-bottom: 16px;"></div>
