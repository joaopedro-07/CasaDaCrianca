              ...
              <div class="form-body">
                ...
                <div class="container-footer-modal">
                  <div class="footer-left">
                    <span id="step-indicator">Passo 1 de 4</span>
                  </div>
                  <div class="footer-right">
                    <button class="btn-cancelar" id="btn-back" onclick="navStep(-1)" style="display:none">← Voltar</button>
                    <button class="btn-salvar" id="btn-next" onclick="navStep(1)">Próximo →</button>
